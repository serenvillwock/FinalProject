...
```{r, multitrait model phenotypic selection}
source("code/implement_selection.R")

MTselection <- implement_pheno_selection(progeny, multitrait=T) 

saveRDS(MTselection, file="data/MTselection_5cycle.RDS")
```

```{r, single trait models phenotypic selection}
STselection <- implement_pheno_selection(progeny, multitrait=F) 

saveRDS(MTselection, file="data/STselection_5cycle.RDS")
```
